...
import au.edu.utas.dengm.tutorialsmarkingapp.databinding.ActivityChooseHdBinding
import au.edu.utas.dengm.tutorialsmarkingapp.databinding.ActivityReportBinding
import com.google.firebase.firestore.ktx.firestore
import com.google.firebase.ktx.Firebase
import java.io.File

class ChooseHdActivity : AppCompatActivity() {
    private lateinit var ui: ActivityChooseHdBinding
    private var week : String = ""
    private var studentposition: Int = -1

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        ui = ActivityChooseHdBinding.inflate(layoutInflater)
